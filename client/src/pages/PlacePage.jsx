...
export default function PlacePage() {
        ...
        return (
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        <h2 className="text-3xl mb-2">Photos of {design.title}</h2>
    ...
    return (
        <div className="mt-4 bg-gray-100 -mx-8 px-8 py-8">
            ...
            <a className="flex gap-1 my-3 block underline" target="_blank" href={'https://maps.google.com/?q='+design.address}>
            ...
            <div className="relative">
                <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                    <div>
                        {design.photos?.[0] && (
                            <div>
                                <img className="bg-gray-200 aspect-square object-cover"
                    ...
                    <div className="grid">
                        ...
                        <div className="overflow-hidden">
                            {design.photos?.[2] && (
                                <img className="bg-gray-200 aspect-square object-cover relative top-2"
