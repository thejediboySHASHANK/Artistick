...
export default function OrderPage() {
    ...
    return (
        <div className="my-8 mx-auto" style={{maxWidth: "1000px"}}>
            ...
            <div className="bg-gray-200 mb-16 rounded-2xl p-2 my-6 flex items-center justify-between md:p-6 md:mb-4">
                <div className="text-md gap-2 mt-2 block">
                    <h2 className="text-xl md:text-2xl">Your order information</h2>
                    <div className="flex mt-4 gap-2 text-sm md:text-lg">
                ...
                <div className="mt-2 bg-primary p-2 text-white rounded-2xl md:p-6">
                    <div className="">Total Price</div>
                    <div className="text-xl md:text-3xl">₹{order.price}</div>
                </div>
            </div>
